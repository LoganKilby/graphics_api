...
set glfw_include_dir=C:\work\Library\glfw-3.3.8\include\
set imgui_src_dir=%code%\imgui

set libs=User32.lib Opengl32.lib Gdi32.lib

set opts=-DDEBUG -D_CRT_SECURE_NO_WARNINGS -FC -GR- -EHa- -nologo -Od -Zo -Oi -fp:fast -fp:except- -Gm- -GR- -EHa- -WX -W4 -wd4201 -wd4100 -wd4189 -wd4505 -wd4127 -FC -Z7 /I%glew_include_dir% /I%shader_dir% /I%glfw_include_dir%
...
cl %opts% %code%\glfw_win32_main.cpp -Feapp_glfw /link /LIBPATH:%lib_dir% %libs% glew32.lib glfw3dll.exp glfw3dll.lib imgui*.obj
popd
popd
